...
- **2026-06-24** 🔥 [**Boogu-Image-0.1-Turbo-hotfix**](https://demo-turbo.boogu.org/) (Text-to-Image) is now online! The new checkpoint will be released tomorrow. This is a minor patch release. We fixed visual artifacts appear in different aspect ratio, background overfitting artifacts, and other artifacts. Model weights are updated, no feature changes. Thanks for the feedback from the open-source community. Please report any failure cases in the GitHub Issues, and we will fix them ASAP.

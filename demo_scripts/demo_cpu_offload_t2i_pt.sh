...
experiment_name=demo_cpu_offload_t2i_pt
use_prompt_tuning=True
enable_model_cpu_offload_flag=True
...
# case_name=t2i_oldman_en_cpu_offload_pt_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
case_name=t2i_oldman_zh_cpu_offload_pt_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
...
python inference.py \
    ...
    --enable_model_cpu_offload_flag $enable_model_cpu_offload_flag \

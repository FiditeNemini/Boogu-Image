...
experiment_name=demo_seq_offload_t2i_pt
...
# case_name=t2i_oldman_en_seq_offload_pt_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
case_name=t2i_oldman_zh_seq_offload_pt_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}

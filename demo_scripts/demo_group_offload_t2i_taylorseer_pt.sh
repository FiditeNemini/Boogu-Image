...
experiment_name=demo_group_offload_t2i_taylorseer_pt
...
# case_name=t2i_oldman_en_group_offload_pt_taylorseer_all_layers_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
case_name=t2i_oldman_zh_group_offload_pt_taylorseer_all_layers_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}

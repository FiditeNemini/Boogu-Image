...
experiment_name=demo_seq_offload_ti2i_teacache_pt
...
case_name=ti2i_rm_dog_seq_offload_teacache_all_layers_pt_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
